...
<main class="flex flex-col items-center justify-center mt-[10vh] m-10">
    <div class="max-w-[800px] flex flex-col items-center text-center">
        ...
        <Button
            variant="filled"
            class="px-4 py-2 mt-10 font-bold m-auto flex"
            onclick={() => goto("/verify")}
        >
            ...
            <img
                ...
                height={24}
                alt="Roblox Logo"
                class="inline-block m-1 ml-2"
            />
        </Button>

        <p class="mt-8 max-w-100 text-neutral-500">
            Just want to test it? No worries you can try it out before you
            decide if you would like to verify your account
        </p>
        <Button
            variant="outlined"
            class="px-4 py-2 mt-4 font-normal m-auto flex"
            onclick={() => console.log("clicked")}>Try a one-time demo</Button
        >
    </div>

    <h2 class="mt-20 text-3xl text-neutral-300 text-center">
        Currently available games
    </h2>
    <div
        class="mt-10 flex flex-wrap justify-center ml-10 mr-10 max-w-[1100px] gap-8"
    >
