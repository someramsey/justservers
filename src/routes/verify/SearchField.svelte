...
<div class="relative w-full">
    <input type="search" bind:value={searchQuery} on:input={handleInput} class="border text-center transition-colors border-neutral-800 hover:border-neutral-700 outline-neutral-700 focus:outline-1 rounded-xl p-2 w-full pl-10 pr-10" placeholder="Enter your username or ID" />
